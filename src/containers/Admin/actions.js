...
export const getCategoryAction = createAction(GET_CATEGORY, async (id) => getCategoryApi(id))
export const editCategoryAction = createAction(EDIT_CATEGORY, async (id, data) => editCategoryApi(id, data))
export const deleteCategoryAction = createAction(DELETE_CATEGORY, async (id) => deleteCategoryApi(id))
...
export const addLessonAction = createAction(ADD_LESSON, async (data) => addLessonApi(data))
export const deleteLessonAction = createAction(DELETE_LESSON, async (id) => deleteLessonApi(id))

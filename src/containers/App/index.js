...
const App = (props) => {
  ...
  return (
    <Switch>
      ...
      <StrictlyPublicRoute exact path={ROUTE_TO_CREATE_ACCOUNT} component={Signup} />
      <StrictlyPublicRoute exact path={ROUTE_PASSWORD_RECOVERY} component={ForgotPassword} />
      <StrictlyPublicRoute exact path={ROUTE_PASSWORD_CHANGE} component={ChangePassword} />

      <PrivateRoute exact path={ROUTE_TO_PROFILE} component={Profile} />
      <PrivateRoute exact path={ROUTE_TO_PAYMENTS_INFO} component={PaymentsInfo} />
      <PrivateRoute exact path={ROUTE_TO_DASHBOARD} component={Dashboard} />
      <PrivateRoute exact path={ROUTE_TO_COURSES} component={Courses} />
      ...
      <AdminRoute exact path={ROUTE_TO_CREATE_COURSE} component={CreateCourse} />
